        ...
        <?php $__empty_1 = true; $__currentLoopData = $payment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan_payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <table class="table table-sm table-hover align-middle bg-white border text-secondary w-75 mx-auto shadow">
                ...
                <tr class="text-align-start" rowspan="5">
                    ...
                    <td class="h6" colspan="1"><span class="fw-bold"><span class="">Total Payments: <span class="text-danger text-center"><?php echo e($total_payments, false); ?></span></td>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                <input type="number" name="principal_amount" id="principal-amount" class="form-control form-control-sm text-center" placeholder="Principal" value="<?php echo e(old('principal_amount'), false); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                <input type="number" name="amount_interest" id="amount-interest" class="form-control form-control-sm text-center" value="<?php echo e(old('amount_interest'), false); ?>" placeholder="Interest">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sdrcc\sdrccoop-final\sdrccoop-app_original\resources\views/members/loans/add-payment.blade.php ENDPATH**/ ?>