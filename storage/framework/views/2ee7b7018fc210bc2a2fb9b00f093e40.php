    ...
    <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="row align-items-center mb-3">
            ...
            <div class="col bg-white p-3 rounded rounded-3 shadow-lg">
                ...
                <p class="mb-0">Member Loan Status: <?php if(!empty($member->loan->member_id)): ?> <span class="badge rounded-pill text-bg-primary">With Loan</span> <?php else: ?> <span class="badge rounded-pill text-bg-secondary">Without Loan</span> <?php endif; ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sdrcc\sdrccoop-final\sdrccoop-app_original\resources\views/members/search.blade.php ENDPATH**/ ?>