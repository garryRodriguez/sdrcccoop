<?php if(Admin::user()->visible(\Illuminate\Support\Arr::get($item, 'roles', [])) && Admin::user()->can(\Illuminate\Support\Arr::get($item, 'permission'))): ?>
    ...
    <?php endif; ?>
<?php endif; ?><?php /**PATH /home/u152326917/domains/sdrcoop.com/public_html/vendor/open-admin-org/open-admin/src/../resources/views/partials/menu.blade.php ENDPATH**/ ?>