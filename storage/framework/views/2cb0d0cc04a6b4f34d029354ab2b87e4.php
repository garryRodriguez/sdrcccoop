...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" name="interest_amount" class="form-control form-control-sm text-center" value="<?php echo e(old('interest_amount', $item->interest)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" name="payment_terms" id="payment-terms" class="form-control form-control-sm text-center" value="<?php echo e(old('payment_terms', $item->term_of_loan)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" name="capital_build_up" class="form-control text-center" value="<?php echo e(old('capital_build_up', ($item->approved_loan_amount * 0.25) > 10000 ? 10000:($item->approved_loan_amount * 0.25))); ?>" arialabelledby="cbu-info">
    ...
    <div class="container-fluid">
        <div class="row">
            <table class="table table-sm table-hover align-middle bg-white border text-secondary w-100 mx-auto shadow text-center">
                <thead>
                    <tr>
                        <th class="bg-success text-white">Loan ID</th>
                ...
                <tbody>
                   <?php if($loan_computed): ?>
                        <?php $__empty_1 = true; $__currentLoopData = $loan_computed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l_computed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($l_computed->loan_id); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sdrcc\sdrccoop-final\sdrccoop-app_original\resources\views/members/loans/loancomputation.blade.php ENDPATH**/ ?>