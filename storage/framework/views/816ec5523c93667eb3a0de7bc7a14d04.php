...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row p-2" style="background-color: #000000;">
                        	<div class="col-4 text-white">
                        		Term of Payment
                                <input type="number" name="term_of_loan" id="term_of_loan" class="form-control">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sdrcc\sdrccoop-final\sdrccoop-app_original\resources\views/members/loans/loan.blade.php ENDPATH**/ ?>