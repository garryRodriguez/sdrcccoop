...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(route('index'), false); ?>">
                    <img src="<?php echo e(url('/img/sdrrcoop-logo.jpg'), false); ?>" alt="sdrcooop logo" class="img-fluid" style="width: 70px; height: 70px;">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(Auth::user()->role_id == 1): ?>
                                <li class="nav-item" title="Home">
                                    <a href="<?php echo e(route('index'), false); ?>" class="nav-link"><i class="fa-solid fa-house"></i> Home</a>
                                </li>
                                
                                <li class="nav-item" title="Add Member">
                                    <a href="<?php echo e(route('addMember'), false); ?>" class="nav-link"><i class="fa-solid fa-circle-user"></i> Add Member</a>
                                </li>
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <i class="fa-solid fa-user"></i> <?php echo e(Auth::user()->name, false); ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <a href="<?php echo e(route('admin.members'), false); ?>" class="dropdown-item">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('logout'), false); ?>"
                                       onclick="event.preventDefault();
                                        ...
                                        <i class="fa-solid fa-right-to-bracket"></i> <?php echo e(__('Logout'), false); ?>
                    ...
                    <?php if(request()->is('admin/*')): ?>
                        <div class="col-2">
                            <div class="list-group">
                                <a href="<?php echo e(route('admin.members'), false); ?>" class=" text-center list-group-item <?php echo e(request()->is('admin/members') ? 'active':'', false); ?>">
...
<?php /**PATH C:\xampp\htdocs\sdrccoop\public_html_final\sdrcccoop\resources\views/layouts/app.blade.php ENDPATH**/ ?>