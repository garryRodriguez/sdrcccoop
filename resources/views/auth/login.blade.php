    ...
    <div class="row justify-content-center bg-white p-5">
        <div class="col-md-8 mt-4">
            <div class="card shadow-lg mt-3">
                <div class="card-header bg-dark text-white">{{ __('Welcome, please login with your account to proceed.') }}</div>
                ...
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end p-3">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end p-3">{{ __('Password') }}</label>
            ...
            <p>Current date and time: {{$ldate = date('Y-m-d H:i:s');}}</p>
        </div>
    </div>
</div>
@endsection
