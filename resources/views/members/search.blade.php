    ...
    @forelse($members as $member)
        <div class="row align-items-center mb-3">
            ...
            <div class="col bg-white p-3 rounded rounded-3 shadow-lg">
                ...
                <p class="mb-0">Member Loan Status: @if (!empty($member->loan->member_id)) <span class="badge rounded-pill text-bg-success">With Loan</span> @else <span class="badge rounded-pill text-bg-dark">Without Loan</span> @endif</p>
                ...
                <a href="{{ route('member.addpaymentpagebyid', $member->id) }}" class="btn btn-dark text-white btn-sm">Add Payment</a>
