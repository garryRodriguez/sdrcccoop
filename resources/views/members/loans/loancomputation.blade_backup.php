                        ...
                        @forelse ( $loan_computed as $l_computed)
                            @if($l_computed->loan_id == $item->id)
                                <tr>
                                    ...
                                    <td>{{$l_computed->principal_amount - ($l_computed->interest_amount + $l_computed->service_charge + $l_computed->capital_build_up + $l_computed->membership_fee + $l_computed->loan_balance)}}</td>
